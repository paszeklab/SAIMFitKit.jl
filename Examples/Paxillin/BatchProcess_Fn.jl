...
opt.dOx = 2050;#1924.9	                #The thickness of the SiO2 layer in units of nm
...
#-------------- FIT PARAMETERS----------------------
p0 = [500, 500.0, 10.0]		    #Initial guesses for parameters [A, B, H]
...
files = ["FN_2"]                             #Names of image stacks; multiple experiments can be listed to run in batch	
path = "/Users/matthewpaszek/Documents/GitHub/SAIMFitKit.jl/example/TestImages" #Path to image files

#-------------- CONDUCT FITS ---------------------
for f in files
    fit_SAIM(path, f, opt, angles, p0, lb, ub, glb=true, step=20.0, show=true)
end
